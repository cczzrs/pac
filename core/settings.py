...
DOWN_URL = r'C:/Users/static_data/pac_excel/' if this_os else r'/home/pac/static_data/pac_excel/'

# 爬虫爬取的图片及文件保存地址
WEB_DOWN_FILE_PATH = r'C:/Users/static_data' if this_os else r'/home/pac/static_data'
# 爬虫爬取的图片及文件，如果已有是否重新下载，否则略过
WEB_DOWN_FILE_REDOWN = False

# 静态文件 static 集成路径
STATIC_ROOT = r'C:/Users/static_data/static/' if this_os else r'/home/pac/static_data/static/'
